                    ...
                    <div class="row w-100 mx-0">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-center py-5 px-4 px-sm-5">
                                ...
                                <form class="pt-3" method="POST" action="{{ route('admin_otp_verification') }}">
                                    ...
                                    <div class="form-group">
                                        <input name="email" type="email" class="form-control form-control-lg" id="exampleInputOtp" placeholder="Email Here.." />
                                        @error('email')
